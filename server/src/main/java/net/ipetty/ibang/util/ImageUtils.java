...
public class ImageUtils {
	...
	private static final String ORGINAL_IMAGE_FILE_PREFIX = "o";
	 ...
	 * 保存图片文件并返回Image对象
	 */
	public static Image saveImage(MultipartFile file, String webContextRealPath) throws IOException {
		...
		image.setSn(shortUuid);
		image.setOriginalUrl(new StringBuilder(ROOT_FILE_RELATIVE_PATH).append(FILE_SEPARATOR)
				.append(ORGINAL_IMAGE_FILE_PREFIX).append(shortUuid).append(".").append(originalFileExtension)
				.toString());
		image.setSmallUrl(new StringBuilder(ROOT_FILE_RELATIVE_PATH).append(FILE_SEPARATOR)
				.append(SMALL_IMAGE_FILE_PREFIX).append(shortUuid).append(".").append(thumbnailFileExtension)
				.toString());
