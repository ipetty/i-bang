...
<link href="${RESOUCE_STATIC_URL}/css/login.min.css?t=4.8.2668563615" type="text/css" rel="stylesheet">
			...
			<div id="main">
				...
				<div class="login">
					<div class="item-username">
						<label>用户名</label>
						<input type="hidden" id="md5Encode" name="md5Encode" value="${md5Encode }" />
						<input type="hidden" id="oldPassword" name="oldPassword" value="${password }" />
						<input type="text" id="username" name="username" class="input-text input-login" value="${username }" />
					</div>
