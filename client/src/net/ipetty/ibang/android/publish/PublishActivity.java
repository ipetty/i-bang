        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (locationResult != null) {
                    ...
                    lvo.setAddress(locationResult.getAddress());
                    lvo.setLatitude(locationResult.getLocation().latitude);
                    lvo.setLongitude(locationResult.getLocation().longitude);
                    seek.setLocation(lvo);
                }
