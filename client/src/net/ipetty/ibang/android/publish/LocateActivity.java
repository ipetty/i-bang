...
public class LocateActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        okBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Constants.BROADCAST_INTENT_DATA_NAME, JSONUtils.toJson(locationResult));
    ...
    private class MyGeoCoderResultListener implements OnGetGeoCoderResultListener {
        ...
        public void onGetGeoCodeResult(GeoCodeResult result) {
            ...
            Toast.makeText(LocateActivity.this, result.getAddress() + ":" + location.toString(), Toast.LENGTH_LONG).show();
