...
public interface SeekApi {
     ...
     */
    @GET("/seeklist/nearlybycategory")
    public List<SeekVO> listNearlyByCategory(@Query("latitude") String latitude,
        @Query("longitude") String longitude, @Query("categoryL1") String categoryL1,
        @Query("categoryL2") String categoryL2, @Query("type") String type, @Query("radius") int radius,
        @Query("pageNumber") int pageNumber, @Query("pageSize") int pageSize);
